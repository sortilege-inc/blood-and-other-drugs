...
| 2026-09-24 | **open for the owner** | **23 Advantage names are in no converted book** — kept as the world spells them and reported on every run: *Enemy* (×7), *Language* (×3), *Disallowed Feeding* (×2), and once each *Amnesia, Convincing Lies, Cult, Danger Sense, Disallowed Influence, Efficient Digestion, Impostor Syndrome, Infamous Deed, Inoffensive to Animals, Iron Will, Natural Leader, Nightmares, Obsession Target, Prestigious Sire, Rival, Ritual Savant, Shunned by Sire, Status Symbol, Vengeful*, and *The Pony Express: Station Agent*. Searched as text, case-insensitively, across every file of both shelves: *Iron Will*, *Efficient Digestion*, *Inoffensive to Animals*, *Prestigious Sire*, *Amnesia*, *Convincing Lies*, *Disallowed Feeding/Influence*, *Impostor Syndrome*, *Infamous Deed*, *Obsession Target*, *Ritual Savant* and *The Pony Express* appear **nowhere**; the rest appear only in prose, never as an Advantage. Candidates for an alias, not taken without you: *Enemy* → the core's *Adversary* (Mawla's Flaw); *Language* → the core's *Linguistics*; *Shunned by Sire* → the Players Guide's *Shunned*. The rest are either from a book not in the corpus or wod5e's own list |
